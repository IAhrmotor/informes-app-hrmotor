...
const campaignPointIcon = `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(`
<svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" xml:space="preserve">
<g id="Spinner_x5F_0_x25_">
    <g>
        ...
        <g>
            <ellipse transform="matrix(1 -0.0098 0.0098 1 -0.4887 0.726)" cx="73.489" cy="50" rx="1.959" ry="1.959"/>
            <g>
                <ellipse transform="matrix(1 -0.0026 0.0026 1 -0.1096 0.1874)" cx="72.131" cy="42.296" rx="1.959" ry="1.959"/>
                <ellipse transform="matrix(1 -0.0026 0.0026 1 -0.0918 0.1775)" cx="68.321" cy="35.432" rx="1.959" ry="1.959"/>
                <ellipse transform="matrix(1 -0.0026 0.0026 1 -0.0784 0.1621)" cx="62.395" cy="30.267" rx="1.959" ry="1.959"/>
                <ellipse transform="matrix(1 -0.0026 0.0026 1 -0.0708 0.1431)" cx="55.076" cy="27.346" rx="1.959" ry="1.959"/>
            </g>
        </g>
    </g>
</g>
    ...
    return seriesDefinitions
        ...
        .flatMap((series) => {
            ...
            return rows.map((row, index) => {
                ...
                return `<span class="line-point-dot ${escapeHtml(series.className)}" style="left:${x.toFixed(2)}%;top:${yPercent.toFixed(2)}%;background-image:url('${campaignPointIcon}')" title="${escapeHtml(tooltip)}" data-tooltip="${escapeHtml(tooltip)}"></span>`;
            });
        })
        .join('');
}
