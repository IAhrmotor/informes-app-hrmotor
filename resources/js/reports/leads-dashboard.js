...
function renderKpis(kpis) {
    ...
    const cards = [
        ...
        { label: 'Sin comercial elegible', value: formatNumber(kpis.without_eligible_commercial), hint: 'Sin usuario activo de perfil comercial válido', metric: 'leads_totales' },
        { label: 'Sin delegación comercial', value: formatNumber(kpis.without_commercial_delegation), hint: 'Comercial elegible sin delegación resoluble', metric: 'leads_totales' },
        { label: 'Sin clasificar', value: formatNumber(kpis.unclassified), hint: 'Lead válido sin delegación clasificada', metric: 'leads_totales' },
